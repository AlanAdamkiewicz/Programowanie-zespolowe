...
--
-- Host: 127.0.0.1
-- Czas generowania: 08 Kwi 2017, 20:32
...
--
-- Baza danych: `hurtowniakomputerowa`
--
...
(1, 'AM', 'Asus', 'Adam Malysz', 'Warszawa, ul. Soprano 8', 888899999, 'yup@yup.ru'),
(2, 'Bbor', 'Acer', 'Antoni Hej', 'Wroclaw ul.Ciepla 4', 876876876, 'wroc98@wp.pl'),
(3, 'WW', 'Dell', 'Wieslaw Wolga', 'Wilczyn 201', 765765765, 'wilczyn@o2.pl');
...
(1, 'Action', 'Pawel Roool', 'Rzeszow ul.Sloneczna 2', 666777666, 'pawel@okon.pl', 5),
(2, 'Botafogo', 'Wieslaw Paleta', 'Ciechocinek 25', 678678678, 'wiesiek@buiaczek.pl', 5),
(3, 'BlueScreen', 'Pawel Los', 'Losienice 204', 888999777, 'losienice@wp.pl', 6);
...
INSERT INTO `produkt` (`produkt_id`, `nazwa`, `cena_jednostkowa`, `ilosc`, `polozenie`, `dostawca_importer_id`, `kraj_pochodzenia`) VALUES
(1, 'Dell OptiPlex i3', 799, 42, '1a', 1, 'Chiny'),
(2, 'Asus RamPage', 3529, 15, '4b', 1, 'Niemcy'),
(3, 'Acer Aspire', 2500, 452, '2a', 3, 'Niemcy'),
(4, 'AMD Radeon Pro ', 899, 11, '1', 3, 'Albania'),
(5, 'Nvidia GTX', 1099, 125, '2', 1, 'Rosja');
...
INSERT INTO `produkt_temp` (`produkt_temp_id`, `nazwa`, `cena_jednostkowa`, `ilosc`, `polozenie`, `dostawca`, `kraj_pochodzenia`, `przyjecie_id`) VALUES
(1, 'Asus rampage', 5, 10, '', 'R.Kalisz', 'Polska', NULL),
(2, 'Acer', 1, 5, '', 'Wroclaw Ciepla', 'Polska', NULL);
...
(1, 'Adam', 'Kowalski', 'Kierownik', 'kierownik', 'kierownik'),
(99, 'Andrzej ', 'Ciepela', 'Administartor', 'admin', 'admin'),
